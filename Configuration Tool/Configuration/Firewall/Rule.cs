...
namespace Configuration_Tool.Configuration.Firewall
{
    public class Rule
    {
        ...
        public static void GetFirewallRules(NET_FW_RULE_DIRECTION_ direction, IList<Rule> rules)
        {
            // Clear list
            rules.Clear();
        ...
        public void Write(BinaryWriter writer)
        {
            ...
            writer.Write(intProtocol);
            writer.Write(LocalPorts);
            writer.Write(RemotePorts);
            writer.Write(LocalAddresses);
            writer.Write(RemoteAddresses);
